...
data_delete = Array();
  ...
  constructor(public dialogService: DialogService,private genreService: GenreService ,private typeEmployeService : TypeEmployeService ,private roleService:RoleService,private service: InfirmierService,private messageService: MessageService, private confirmationService: ConfirmationService) { }
  ngOnInit() {
  this.items = [
        {label: 'Facture'},
    ...
    this.service.getListe().then(
      data => this.liste = data.filter(val => val.active == 0));
